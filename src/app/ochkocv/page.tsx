        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr]">
          ...
          <div className="space-y-8 p-8 lg:p-12">
            ...
            <div className="space-y-3 leading-relaxed text-foreground">
              <p>
              Fullstack хегжуулэгчээр 9+ тесел амжилттай хэрэгжуулсэн туршлагатай.
React, Node.js, MongoDB зэрэг технологиудыг ашиглан UI/UX, backend логик,
authentication системуудийг хегжуулж, теслийн гуйцэтгэлийг дунджаар 20%
сайжруулсан. Багийн ажлыг удирдах, нарийн тевогтэй асуудлыг шийдвэрлэх
ендер ур чадвартай.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 border-l-4 border-[#4F46E5] pl-6">
                ...
                EventLux төслийн багийг ахалж, route бүтэц, authentication болон хөгжүүлэлтийн суурь шийдлийг амжилттай тодорхойлсон. - Алдаа засвар, navigation логик сайжруулалт хийж, системийн тогтвортой ажиллагааг 99.5% хангасан.
                  </ul>
                </div>
              ...
              <div className="space-y-3 border-l-4 border-[#4F46E5] pl-6">
                ...
                <div className="space-y-2">
                  <p className="font-semibold text-foreground">Миний оролцоо</p>
                  <ul className="list-inside list-disc space-y-1.5 leading-relaxed text-foreground">
                 Багийг ахалж, route бүтэц, authentication болон хөгжүүлэлтийн суурь шийдлийг төлөвлөж, хөгжүүлэлтийн стандартыг тогтоосон

Axios, Cheerio болон Regex ашиглан сургуулийн сайтаас мэдээллийг автомат fetch, боловсруулж, гараар оруулах шаардлагыг бууруулсан

Хувийн календарь дээр бүртгэл нэмэх, эхлэх/дуусах өдрийг тэмдэглэх боломжийг нэвтрүүлсэн

Алдаа засвар, navigation болон notification логик сайжруулж, системийн тогтвортой ажиллагааг 99.5%-д хүргэсэн

GitHub ашиглан merge conflict шийдвэрлэж, багийн кодын чанар, build алдааг хянасан
                  </ul>
                </div>
